<template>
  <div class="hero-profile">
    ...
    <div class="terminal-header">
      ...
      <div class="terminal-title">~/developer/profile.sh</div>
    </div>
    ...
    <div class="profile-content">
      ...
      <div class="profile-main">
        ...
        <div class="profile-info">
          ...
          <h1 class="profile-name">
            <span class="name-const">const</span>
            <span class="name-variable">developer</span>
            <span class="name-equal">=</span>
            <span class="name-value">"钱嘉豪"</span>
          </h1>
          <p class="profile-bio">
      ...
      <div class="tech-stack">
        <div class="command-prompt">
          <span class="prompt-symbol">$</span>
          <span class="command-text">cat techstack.json</span>
        </div>
        <div class="tech-grid">
      ...
      <div class="social-links">
        <div class="command-prompt">
          <span class="prompt-symbol">$</span>
          <span class="command-text">ls -la ~/social</span>
        </div>
      ...
      <div class="stats-section">
        <div class="command-prompt">
          <span class="prompt-symbol">$</span>
          <span class="command-text">git stats --summary</span>
        </div>
...
const socialLinks = ref([
  ...
  },
  {
    ...
    icon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 2H5c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM9 4h2v5l-1-.75L9 9V4zm8 16H7v-1h10v1zm2-2H5V4h2v9l3-2.25L13 13V4h6v14z"/></svg>'
  },
  {
    name: 'Email',
  ...
  },
  {
    ...
    icon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M22.46 6c-.85.38-1.78.64-2.75.76 1-.6 1.76-1.55 2.12-2.68-.93.55-1.96.95-3.06 1.17-.88-.94-2.13-1.53-3.51-1.53-2.66 0-4.81 2.16-4.81 4.81 0 .38.04.75.13 1.1-4-.2-7.54-2.12-9.91-5.04-.42.72-.66 1.55-.66 2.44 0 1.67.85 3.14 2.14 4-.79-.03-1.53-.24-2.18-.6v.06c0 2.33 1.66 4.28 3.86 4.72-.4.11-.83.17-1.27.17-.31 0-.62-.03-.92-.08.62 1.94 2.42 3.35 4.55 3.39-1.67 1.31-3.77 2.09-6.05 2.09-.39 0-.78-.02-1.17-.07 2.18 1.4 4.77 2.21 7.55 2.21 9.06 0 14.01-7.5 14.01-14.01 0-.21 0-.42-.02-.63.96-.69 1.8-1.56 2.46-2.55z"/></svg>'
  }
])
...
.avatar-hexagon {
  ...
  background: linear-gradient(135deg, #007acc 0%, #569cd6 100%);
  padding: 3px;
